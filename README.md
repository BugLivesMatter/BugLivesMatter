...
**Backend Developer** · Go & Python · 4th year CS student
...
- Deepening Go knowledge for production-grade backend development
- Exploring microservices patterns with RabbitMQ + Docker
...
*"The best code is the code that doesn't exist yet — but when it does, it should work."*
